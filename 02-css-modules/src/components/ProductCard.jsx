  ...
  return (
    <article className={styles.card} tabIndex={0} aria-labelledby={`title-${product.id}`}>
      <div className={styles.imageWrap}>
        {loading ? <div style={{width:'100%',height:'100%'}} className={"skeleton"}/> : <img src={product.image} alt={product.title} loading="lazy" style={{width:'100%',height:'100%',objectFit:'cover',display:'block'}} />}
      </div>
